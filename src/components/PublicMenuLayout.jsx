        ...
        <Box>
          ...
          <Box p={4}>
            ...
            flexDirection={{xs: "column", md: "row"}}>
                <Typography variant='h4' color='text.primary' fontWeight={700} sx={{fontFamily}}>
                {selectedItem?.name}
                </Typography>
                <Typography variant='h5' fontWeight={700} color='primary.main' sx={{fontFamily, whiteSpace: 'nowrap'}}>
                    {selectedItem?.price}
                    {selectedItem?.currency === "USD" && "$"}
                    {selectedItem?.currency === "TL" && "₺"}
                    {selectedItem?.currency === "SDG" && "ج.س"}
                </Typography>
            </Box>
            <Typography variant='body1' color='text.secondary' mt={2} sx={{fontFamily}}>
